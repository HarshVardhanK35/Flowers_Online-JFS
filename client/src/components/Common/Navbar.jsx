...
const Navbar = () => {
  const [cartItems, setCartItems] = useState(0); // Tracks cart items
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex flex-shrink-0 items-center">
              <a href="/">
                <img alt="9Flowers.Online" src="/logo.webp" className="h-8 w-auto rounded-md" />
              </a>
            </div>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <a
              ...
              className={`relative rounded-full p-1 ${cartItems > 0 ? 'bg-green-600' : 'bg-gray-800'} text-gray-400 hover:text-white`}
            >
            ...
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                  ...
                  <img alt="" src="/profile.jpg" className="h-8 w-8 rounded-full" />
                </MenuButton>
              </div>
