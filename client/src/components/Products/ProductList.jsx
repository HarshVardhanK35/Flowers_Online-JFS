        ...
        <div className="mx-auto max-w-2xl px-4 py-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">
            {role === "ROLE_ADMIN"
              ...
              ? "All Flower Bouquets"
              : `${selectedCategory.charAt(0).toUpperCase() + selectedCategory.slice(1)} Bouquets`}
          </h2>

          {/* Render ProductFilter with category filter on the /products/all route */}
          {role !== "ROLE_ADMIN" && location.pathname === "/products/all" && (
            <ProductFilter
              onSearch={handleSearch}
              onFilter={handleFilter}
              onClearFilter={handleClearFilter}
              onResetFilters={handleResetFilters}
              showCategoryFilter={true} // Show category filter
              ...
              filteredProducts.map((product) => (
                ...
                >
                  ...
                  <div className="ml-5 flex flex-col justify-between w-1/2">
                    <div>
                      <motion.a
                        href={role === "ROLE_ADMIN" ? `/admin/products` : `/product/${product.id}`}
                      >
