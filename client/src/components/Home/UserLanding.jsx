					...
					<div className="hidden lg:flex lg:gap-x-5">
						{navigation.map((item) => (
							<a
								key={item.name}
								href={item.href}
								className="text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-200 hover:text-black rounded-md px-3 py-2"
							>
								{item.name}
							</a>
						))}
			...
			<div className="relative isolate px-6 pt-14 lg:px-8">
				...
				<div className="mx-auto max-w-2xl py-32 sm:py-40 lg:py-30">
					<div className="text-center">
						...
						<p className="mt-6 text-lg leading-8 text-gray-600">
							Explore beautiful floral arrangements, personalized flowers, and
							more.
						</p>
						<p>Find the perfect flower for every occasion at 9Flower.Online.</p>
						<div className="mt-10 flex items-center justify-center gap-x-2">
							...
							<a
								href="/login"
								className="text-sm font-semibold leading-6 text-gray-900 hover:bg-indigo-600 hover:text-white rounded-md px-2 py-1"
							>
				...
				>
					<div
						...
						className="relative left-[calc(50%+13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%+6rem)] sm:w-[82.1875rem]"
					/>
				</div>
			</div>
		</div>
